...
class ImprovedRSIStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        # Create cross-over signals for clean entry/exit logic
        self.oversold_cross = bt.indicators.CrossOver(
            self.rsi, 
            self.params.oversold
        )
        
        self.overbought_cross = bt.indicators.CrossOver(
        ...
        if self.params.printlog:
            print("-" * 50)
            print("Improved RSI Reversal Strategy initialized:")
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if self.oversold_cross > 0:  # RSI crossed above oversold level
            ...
            if self.overbought_cross > 0:  # RSI crossed below overbought level
                # Sell signal
